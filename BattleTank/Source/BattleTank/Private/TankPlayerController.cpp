...
void ATankPlayerController::AimTowardsCrosshair() const
{
	...
	if (bGotHitLocation) // HAS "side-effect", is going to line trace //parsing Hitlocation as the thing going to be used as the OUT parameter
	{
...
//	HitLocation = FVector(1.0);
	...
	if(GetLookDirection(ScreenLocation,LookDirection)) 
	{
		...
		return GetLookVectorHitLocation(LookDirection, HitLocation); // LINE-TRACE METHOD CALL // Parse LookDirection // and parse in HitLocation as an OUT parameter
	}
		
	return false; // if cant get a LookDirection, return false
}
